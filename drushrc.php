...
$options['shell-aliases']['wipe'] = '!drush cache-clear all && drush cron';
$options['shell-aliases']['unsuck'] = 'pm-disable -y overlay, dashboard, color, contextual';
$options['shell-aliases']['up'] = 'pm-update';
